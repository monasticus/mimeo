...
class HttpConsumer(Consumer):
    ...
    def __init__(self, output_details: MimeoOutputDetails):
        ...
        auth_impl = HTTPBasicAuth if output_details.auth == "basic" else HTTPDigestAuth
        self.__auth = auth_impl(output_details.username, output_details.password)
